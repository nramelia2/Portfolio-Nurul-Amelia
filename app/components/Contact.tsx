...
export default function Contact() {
    return (
        <section
            ...
            "
        >
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-400/20 dark:bg-blue-500/20 blur-3xl rounded-full" />
            <div className="absolute bottom-0 left-0 w-[420px] h-[420px] bg-indigo-400/20 dark:bg-indigo-500/20 blur-3xl rounded-full" />
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                ...
                <p className="mt-6 text-blue-100 max-w-2xl mx-auto leading-8">
                    Open to Data Engineer, Data Analyst, Analytics Engineer,
                    Machine Learning Engineer, Artificial Intelligence Engineer,
                    and BI-related opportunities.
                </p>
